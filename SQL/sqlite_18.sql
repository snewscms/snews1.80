...
'<p>If you are seeing this article, you have installed <strong>sNews 1.80</strong> and it is connected to the database (sQlite 3).</p><p>It is <strong>strongly</strong> suggested that you <a href="login/" title="Login">login</a> right away, then go to the page <em>Settings</em>. At the bottom of that page you willl find <em>Change Username and Password</em>. <strong>Do it</strong> and make the password hard to guess.</p>
